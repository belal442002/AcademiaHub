        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Active_TF = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_questionBank_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_questionBank_Difficulties_DifficultyId",
                        column: x => x.DifficultyId,
                        principalTable: "Difficulties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_questionBank_QuestionTypes_QuestionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionsForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionsForms_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionsForms_FormDetails_FormDetailsId",
                        column: x => x.FormDetailsId,
                        principalTable: "FormDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionsForms_FormTypes_FormTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_Classrooms", x => new { x.StudentId, x.ClassroomId });
                    table.ForeignKey(
                        name: "FK_Student_Classrooms_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_Classrooms_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teacher_Classrooms", x => x.TeacherId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QBAnswers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Form_Questions", x => new { x.FormId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_Form_Questions_QuestionsForms_FormId",
                        column: x => x.FormId,
                        principalTable: "QuestionsForms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Form_Questions_questionBank_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "questionBank",
                        principalColumn: "QuestionId");
                });
            ...
            migrationBuilder.CreateTable(
                name: "Student_QuestionsForms",
                columns: table => new
                {
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QuestionsFormId = table.Column<int>(type: "int", nullable: false),
                    Grade = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_QuestionsForms", x => new { x.StudentId, x.QuestionsFormId });
                    table.ForeignKey(
                        name: "FK_Student_QuestionsForms_QuestionsForms_QuestionsFormId",
                        column: x => x.QuestionsFormId,
                        principalTable: "QuestionsForms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_QuestionsForms_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Form_Questions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_questionBank_ClassroomId",
                table: "questionBank",
                column: "ClassroomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionsForms_ClassroomId",
                table: "QuestionsForms",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionsForms_FormDetailsId",
                table: "QuestionsForms",
                column: "FormDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionsForms_FormTypeId",
                table: "QuestionsForms",
                column: "FormTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Student_Classrooms_ClassroomId",
                table: "Student_Classrooms",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_Student_QuestionsForms_QuestionsFormId",
                table: "Student_QuestionsForms",
                column: "QuestionsFormId");
